...
class Tokenizer {
  ...
  private static final Map<String, Integer> mTokensMap = new HashMap<String, Integer>() {{
    put("NUMBER", 4); put("STRING", 5); put("SYMBOL", 6); put("&", 7); put("'('", 8); put("')'", 9); put("$", 10);
  }};
...
public class Parser {
  ...
  static {
    mTable.add(new HashMap<Integer, String>() {{ put(0, "1"); put(1, "2"); put(2, "3"); put(4, "s4"); put(5, "s5"); put(6, "s6"); put(7, "s7"); put(8, "s8"); }});
    mTable.add(new HashMap<Integer, String>() {{ put(10, "acc"); }});
    mTable.add(new HashMap<Integer, String>() {{ put(4, "r1"); put(5, "r1"); put(6, "r1"); put(7, "r1"); put(8, "r1"); put(9, "r1"); put(10, "r1"); }});
    mTable.add(new HashMap<Integer, String>() {{ put(4, "r2"); put(5, "r2"); put(6, "r2"); put(7, "r2"); put(8, "r2"); put(9, "r2"); put(10, "r2"); }});
    mTable.add(new HashMap<Integer, String>() {{ put(4, "r3"); put(5, "r3"); put(6, "r3"); put(7, "r3"); put(8, "r3"); put(9, "r3"); put(10, "r3"); }});
    mTable.add(new HashMap<Integer, String>() {{ put(4, "r4"); put(5, "r4"); put(6, "r4"); put(7, "r4"); put(8, "r4"); put(9, "r4"); put(10, "r4"); }});
    mTable.add(new HashMap<Integer, String>() {{ put(4, "r5"); put(5, "r5"); put(6, "r5"); put(7, "r5"); put(8, "r5"); put(9, "r5"); put(10, "r5"); }});
    mTable.add(new HashMap<Integer, String>() {{ put(4, "r6"); put(5, "r6"); put(6, "r6"); put(7, "r6"); put(8, "r6"); put(9, "r6"); put(10, "r6"); }});
    mTable.add(new HashMap<Integer, String>() {{ put(3, "9"); put(4, "r9"); put(5, "r9"); put(6, "r9"); put(7, "r9"); put(8, "r9"); put(9, "r9"); }});
    mTable.add(new HashMap<Integer, String>() {{ put(0, "11"); put(1, "2"); put(2, "3"); put(4, "s4"); put(5, "s5"); put(6, "s6"); put(7, "s7"); put(8, "s8"); put(9, "s10"); }});
    mTable.add(new HashMap<Integer, String>() {{ put(4, "r7"); put(5, "r7"); put(6, "r7"); put(7, "r7"); put(8, "r7"); put(9, "r7"); put(10, "r7"); }});
    mTable.add(new HashMap<Integer, String>() {{ put(4, "r8"); put(5, "r8"); put(6, "r8"); put(7, "r8"); put(8, "r8"); put(9, "r8"); }});
  };
...
((Exp) ((_1.semanticValue))).list.add( (Exp) (_2.semanticValue)); __.semanticValue = (_1.semanticValue);
  }
